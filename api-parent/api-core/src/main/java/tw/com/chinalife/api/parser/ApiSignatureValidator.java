...
/**
 * This class validates value of the `X-API-Signature` header.
 */
public class ApiSignatureValidator implements SignatureValidator {
	 ...
	 */
	public ApiSignatureValidator(byte[] channelSecret) {
	 ...
	 * @param headerSignature Signature value from `X-API-Signature` HTTP header
	 * @return True if headerSignature matches signature of the content. False
	 *         otherwise.
	 */
	@Override
